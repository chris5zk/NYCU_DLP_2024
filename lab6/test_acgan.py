...
def test(args, netG, evaluator, test_dataloader, device):
    netG.eval()
    x_gen, label = [], []
...
if __name__ == '__main__':
    ...
    # path
    parser.add_argument('--weight_path', type=str, default='./output/acgan', help='ACGAN weight root path')
    parser.add_argument('--output_path', type=str, default='./results/acgan', help='infernece results saving path')
